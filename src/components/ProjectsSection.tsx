...
const projects = [
	{
		...
		description:
			"Real-time competitive gaming platform for managing tournaments, live match interactions, and secure online payments.",
		tech: ["Spring Boot", "React.js", "WebSocket", "MySQL", "PayHere"],
		// mapped repository: SpringBootFinalProject (assumption)
		link: "https://github.com/nethushinavodya/SpringBootFinalProject.git",
	},
	{
		num: "02",
		title: "Study Zone",
		...
		description:
			"Mobile learning platform where students can ask and answer academic questions, and access study materials.",
		tech: ["React Native", "Firebase Firestore", "Firebase Auth"],
		link: "https://github.com/nethushinavodya/Study_Zone-App.git",
	},
	{
		num: "03",
		title: "AdoptSmart",
		...
		description:
			"Full-stack MERN application connecting pet shelters with adopters to streamline the adoption process.",
		tech: ["React.js", "Node.js", "Express.js", "MongoDB"],
		link: "https://github.com/nethushinavodya/AdoptSmart_Frontend.git",
	},
	{
		num: "04",
		title: "HiddenVibes",
		...
		description:
			"Full-stack web app for discovering and sharing hidden travel destinations in Sri Lanka with admin approval.",
		tech: ["Next.js", "TypeScript", "Payload CMS", "MongoDB"],
		// corrected/assumed URL (original input concatenated links) -> added .git
		link: "https://github.com/nethushinavodya/HiddenVibes.git",
	},
];
							...
							<div className="flex items-start gap-6">
								...
								<div className="flex-1">
									<div className="flex items-start justify-between mb-3">
										...
										{/* If a link exists, make the icon open the repo in a new tab */}
										{project.link ? (
											<a
												href={project.link}
												target="_blank"
											...
											>
												<ArrowUpRight className="w-5 h-5 text-muted-foreground hover:text-foreground hover:translate-x-1 hover:-translate-y-1 transition-all shrink-0 mt-2" />
											</a>
										) : (
